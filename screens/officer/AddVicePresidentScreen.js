...
export default class AddVicePresidentScreen extends React.Component {
  constructor(props) {
    super(props);
  ...
  onPress = () => {
    ...
    var set = firebase.database().ref('Users').child(key).set({ ...this.state, _key: key, status: 'v', password: passwordHasSet ? md5(password) : password });
    set.then((data) => {
        this.setState({
          userId: '',
          password: '',
